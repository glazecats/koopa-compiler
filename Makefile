...
SEMANTIC_REGRESSION_BIN := $(PARSER_BUILD_DIR)/semantic_regression_test
...
$(SEMANTIC_REGRESSION_BIN): src/lexer/lexer.c src/ast/ast.c src/parser/parser.c src/semantic/semantic.c tests/parser/semantic_regression_test.c include/lexer.h include/ast.h include/ast_internal.h include/parser.h include/semantic.h | dirs
	$(CC) $(CFLAGS) src/lexer/lexer.c src/ast/ast.c src/parser/parser.c src/semantic/semantic.c tests/parser/semantic_regression_test.c -o $@
