...
typedef enum {
    ...
    MACHINE_SELECT_OP_MATERIALIZE_IMM = 1,
    MACHINE_SELECT_OP_ALU = 2,
    MACHINE_SELECT_OP_ALU_IMM = 3,
    MACHINE_SELECT_OP_CMP = 4,
    MACHINE_SELECT_OP_CMP_IMM = 5,
    MACHINE_SELECT_OP_CALL = 6,
    MACHINE_SELECT_OP_CALL_IMM = 7,
    MACHINE_SELECT_OP_CALL_SPILL = 8,
    MACHINE_SELECT_OP_CALL_IMM_SPILL = 9,
    MACHINE_SELECT_OP_CALL_VOID = 10,
    MACHINE_SELECT_OP_CALL_VOID_IMM = 11,
    MACHINE_SELECT_OP_ADDR_LOCAL = 12,
    MACHINE_SELECT_OP_ADDR_GLOBAL = 13,
    MACHINE_SELECT_OP_LOAD_LOCAL = 14,
    MACHINE_SELECT_OP_STORE_LOCAL = 15,
    MACHINE_SELECT_OP_STORE_LOCAL_IMM = 16,
    MACHINE_SELECT_OP_LOAD_GLOBAL = 17,
    MACHINE_SELECT_OP_STORE_GLOBAL = 18,
    MACHINE_SELECT_OP_STORE_GLOBAL_IMM = 19,
    MACHINE_SELECT_OP_LOAD_INDIRECT = 20,
    MACHINE_SELECT_OP_STORE_INDIRECT = 21,
    MACHINE_SELECT_OP_ADDR_FUNCTION = 22,
    MACHINE_SELECT_OP_MAX = MACHINE_SELECT_OP_ADDR_FUNCTION,
} MachineSelectOpKind;
