...
static int test_ir_accepts_three_hop_dynamic_returned_function_parameter_capture_inside_closure_under_extension(void) {
    char *actual_text = NULL;
    int ok = 0;
...
static int test_ir_accepts_alias_of_dynamic_returned_function_parameter_capture_inside_closure_under_extension(void) {
    char *actual_text = NULL;
    int ok = 0;
...
static int test_ir_accepts_ternary_actual_argument_of_dynamic_returned_function_parameter_capture_inside_closure_under_extension(void) {
    char *actual_text = NULL;
    int ok = 0;
...
static int test_ir_accepts_passthrough_local_bind_of_ternary_dynamic_returned_function_parameter_capture_inside_closure_under_extension(void) {
    char *actual_text = NULL;
    int ok = 0;
...
static int test_ir_accepts_multiple_dynamic_returned_closure_function_arguments_under_extension(void) {
    char *actual_text = NULL;
    int ok = 0;
...
int main(void) {
    ...
    if (filter && filter[0] != '\0') {
        ...
        if (strstr("IR-THREEHOP-DYNAMIC-RETURNED-CLOSURE-CAPTURE-PARAM-FNVAL", filter) != NULL) {
            return test_ir_accepts_three_hop_dynamic_returned_function_parameter_capture_inside_closure_under_extension() ? 0 : 1;
        }
        if (strstr("IR-ALIAS-DYNAMIC-RETURNED-CLOSURE-CAPTURE-PARAM-FNVAL", filter) != NULL) {
            return test_ir_accepts_alias_of_dynamic_returned_function_parameter_capture_inside_closure_under_extension() ? 0 : 1;
        }
        if (strstr("IR-TERNARY-ACTUAL-DYNAMIC-RETURNED-CLOSURE-CAPTURE-PARAM-FNVAL", filter) != NULL) {
            return test_ir_accepts_ternary_actual_argument_of_dynamic_returned_function_parameter_capture_inside_closure_under_extension() ? 0 : 1;
        }
        if (strstr("IR-PASSTHROUGH-LOCAL-BIND-TERNARY-DYNAMIC-RETURNED-CLOSURE-CAPTURE-PARAM-FNVAL", filter) != NULL) {
            return test_ir_accepts_passthrough_local_bind_of_ternary_dynamic_returned_function_parameter_capture_inside_closure_under_extension() ? 0 : 1;
        }
