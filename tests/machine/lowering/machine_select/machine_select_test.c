...
static int test_machine_select_accepts_recursive_explicit_float_condition_under_extension(void) {
    static const char *source =
    ...
    if (!build_machine_ir_report_from_extension_source_text(source, &machine_report, &machine_error) ||
        ...
        !machine_select_dump_lower_report_artifact(&select_report, &actual_text, &select_error)) {
        fprintf(stderr,
            "[machine-select] FAIL: MACHINE-SELECT-FLOAT-CONVERT-RECURSIVE-COND-ACCEPT setup failed: %s\n",
            select_error.message[0] ? select_error.message : machine_error.message);
        ok = 0;
        goto cleanup;
    }
    ...
    if (!strstr(actual_text, "function add3 params=3 locals=3 spills=0") ||
        ...
        !strstr(actual_text, "reti 0")) {
        fprintf(stderr,
            "[machine-select] FAIL: MACHINE-SELECT-FLOAT-CONVERT-RECURSIVE-COND-ACCEPT dump mismatch\nactual:\n%s\n",
            actual_text ? actual_text : "<null>");
        ok = 0;
    }
...
static int test_machine_select_accepts_chained_float_equality_compare_under_extension(void) {
    static const char *source =
    ...
    if (!build_machine_ir_report_from_default_extension_source_text(source, &machine_report, &machine_error) ||
        ...
        !machine_select_dump_lower_report_artifact(&select_report, &actual_text, &select_error)) {
        fprintf(stderr,
            "[machine-select] FAIL: MACHINE-SELECT-FLOAT-CHAIN-ADD-EQ-COMPARE-ACCEPT setup failed: %s\n",
            select_error.message[0] ? select_error.message : machine_error.message);
        ok = 0;
        goto cleanup;
    }
    ...
    if (!strstr(actual_text, "function eq params=3") ||
        ...
        !strstr(actual_text, "ret reg.")) {
        fprintf(stderr,
            "[machine-select] FAIL: MACHINE-SELECT-FLOAT-CHAIN-ADD-EQ-COMPARE-ACCEPT dump mismatch\nactual:\n%s\n",
            actual_text ? actual_text : "<null>");
        ok = 0;
    }
...
static int test_machine_select_accepts_chained_float_relational_compare_under_extension(void) {
    static const char *source =
    ...
    if (!build_machine_ir_report_from_default_extension_source_text(source, &machine_report, &machine_error) ||
        ...
        !machine_select_dump_lower_report_artifact(&select_report, &actual_text, &select_error)) {
        fprintf(stderr,
            "[machine-select] FAIL: MACHINE-SELECT-FLOAT-CHAIN-ADD-LT-COMPARE-ACCEPT setup failed: %s\n",
            select_error.message[0] ? select_error.message : machine_error.message);
        ok = 0;
        goto cleanup;
    }
    ...
    if (!strstr(actual_text, "function lt params=3") ||
        ...
        !strstr(actual_text, "ret reg.")) {
        fprintf(stderr,
            "[machine-select] FAIL: MACHINE-SELECT-FLOAT-CHAIN-ADD-LT-COMPARE-ACCEPT dump mismatch\nactual:\n%s\n",
            actual_text ? actual_text : "<null>");
        ok = 0;
    }
...
static int test_machine_select_accepts_nested_muldiv_float_equality_compare_under_extension(void) {
    static const char *source =
    ...
    if (!build_machine_ir_report_from_default_extension_source_text(source, &machine_report, &machine_error) ||
        ...
        !machine_select_dump_lower_report_artifact(&select_report, &actual_text, &select_error)) {
        fprintf(stderr,
            "[machine-select] FAIL: MACHINE-SELECT-FLOAT-NESTED-MUL-DIV-EQ-COMPARE-ACCEPT setup failed: %s\n",
            select_error.message[0] ? select_error.message : machine_error.message);
        ok = 0;
        goto cleanup;
    }
    ...
    if (!strstr(actual_text, "function eq params=3") ||
        ...
        !strstr(actual_text, "ret reg.")) {
        fprintf(stderr,
            "[machine-select] FAIL: MACHINE-SELECT-FLOAT-NESTED-MUL-DIV-EQ-COMPARE-ACCEPT dump mismatch\nactual:\n%s\n",
            actual_text ? actual_text : "<null>");
        ok = 0;
    }
...
static int test_machine_select_accepts_nested_muldiv_float_relational_compare_under_extension(void) {
    static const char *source =
    ...
    if (!build_machine_ir_report_from_default_extension_source_text(source, &machine_report, &machine_error) ||
        ...
        !machine_select_dump_lower_report_artifact(&select_report, &actual_text, &select_error)) {
        fprintf(stderr,
            "[machine-select] FAIL: MACHINE-SELECT-FLOAT-NESTED-MUL-DIV-LT-COMPARE-ACCEPT setup failed: %s\n",
            select_error.message[0] ? select_error.message : machine_error.message);
        ok = 0;
        goto cleanup;
    }
    ...
    if (!strstr(actual_text, "function lt params=3") ||
        ...
        !strstr(actual_text, "ret reg.")) {
        fprintf(stderr,
            "[machine-select] FAIL: MACHINE-SELECT-FLOAT-NESTED-MUL-DIV-LT-COMPARE-ACCEPT dump mismatch\nactual:\n%s\n",
            actual_text ? actual_text : "<null>");
        ok = 0;
    }
...
static int test_machine_select_accepts_chained_float_inequality_compare_under_extension(void) {
    static const char *source =
    ...
    if (!build_machine_ir_report_from_default_extension_source_text(source, &machine_report, &machine_error) ||
        ...
        !machine_select_dump_lower_report_artifact(&select_report, &actual_text, &select_error)) {
        fprintf(stderr,
            "[machine-select] FAIL: MACHINE-SELECT-FLOAT-CHAIN-ADD-NE-COMPARE-ACCEPT setup failed: %s\n",
            select_error.message[0] ? select_error.message : machine_error.message);
        ok = 0;
        goto cleanup;
    }
    ...
    if (!strstr(actual_text, "function ne params=3") ||
        !strstr(actual_text, "call __builtin_fadd32(") ||
        !strstr(actual_text, "cmp.") ||
        !strstr(actual_text, "ret reg.")) {
        fprintf(stderr,
            "[machine-select] FAIL: MACHINE-SELECT-FLOAT-CHAIN-ADD-NE-COMPARE-ACCEPT dump mismatch\nactual:\n%s\n",
            actual_text ? actual_text : "<null>");
        ok = 0;
    }
...
static int test_machine_select_accepts_chained_float_le_compare_under_extension(void) {
    static const char *source =
    ...
    if (!build_machine_ir_report_from_default_extension_source_text(source, &machine_report, &machine_error) ||
        ...
        !machine_select_dump_lower_report_artifact(&select_report, &actual_text, &select_error)) {
        fprintf(stderr,
            "[machine-select] FAIL: MACHINE-SELECT-FLOAT-CHAIN-ADD-LE-COMPARE-ACCEPT setup failed: %s\n",
            select_error.message[0] ? select_error.message : machine_error.message);
        ok = 0;
        goto cleanup;
    }
    ...
    if (!strstr(actual_text, "function le params=3") ||
        ...
        !strstr(actual_text, "ret reg.")) {
        fprintf(stderr,
            "[machine-select] FAIL: MACHINE-SELECT-FLOAT-CHAIN-ADD-LE-COMPARE-ACCEPT dump mismatch\nactual:\n%s\n",
            actual_text ? actual_text : "<null>");
        ok = 0;
    }
...
static int test_machine_select_accepts_nested_muldiv_float_inequality_compare_under_extension(void) {
    static const char *source =
    ...
    if (!build_machine_ir_report_from_default_extension_source_text(source, &machine_report, &machine_error) ||
        ...
        !machine_select_dump_lower_report_artifact(&select_report, &actual_text, &select_error)) {
        fprintf(stderr,
            "[machine-select] FAIL: MACHINE-SELECT-FLOAT-NESTED-MUL-DIV-NE-COMPARE-ACCEPT setup failed: %s\n",
            select_error.message[0] ? select_error.message : machine_error.message);
        ok = 0;
        goto cleanup;
    }
    ...
    if (!strstr(actual_text, "function ne params=3") ||
        ...
        !strstr(actual_text, "ret reg.")) {
        fprintf(stderr,
            "[machine-select] FAIL: MACHINE-SELECT-FLOAT-NESTED-MUL-DIV-NE-COMPARE-ACCEPT dump mismatch\nactual:\n%s\n",
            actual_text ? actual_text : "<null>");
        ok = 0;
    }
...
static int test_machine_select_accepts_nested_muldiv_float_ge_compare_under_extension(void) {
    static const char *source =
    ...
    if (!build_machine_ir_report_from_default_extension_source_text(source, &machine_report, &machine_error) ||
        ...
        !machine_select_dump_lower_report_artifact(&select_report, &actual_text, &select_error)) {
        fprintf(stderr,
            "[machine-select] FAIL: MACHINE-SELECT-FLOAT-NESTED-MUL-DIV-GE-COMPARE-ACCEPT setup failed: %s\n",
            select_error.message[0] ? select_error.message : machine_error.message);
        ok = 0;
        goto cleanup;
    }
    ...
    if (!strstr(actual_text, "function ge params=3") ||
        ...
        !strstr(actual_text, "ret reg.")) {
        fprintf(stderr,
            "[machine-select] FAIL: MACHINE-SELECT-FLOAT-NESTED-MUL-DIV-GE-COMPARE-ACCEPT dump mismatch\nactual:\n%s\n",
            actual_text ? actual_text : "<null>");
        ok = 0;
    }
...
static int test_machine_select_accepts_float_helper_wrapped_ternary_call_arithmetic_under_extension(void) {
    static const char *source =
        "float g = 1.25;\n"
        "float h = 2.5;\n"
    ...
    if (!build_machine_ir_report_from_default_extension_source_text(source, &machine_report, &machine_error) ||
        ...
        !machine_select_dump_lower_report_artifact(&select_report, &actual_text, &select_error)) {
        fprintf(stderr,
            "[machine-select] FAIL: MACHINE-SELECT-FLOAT-HELPER-TERNARY-CALL-ARITH-ACCEPT setup failed: %s\n",
            select_error.message[0] ? select_error.message : machine_error.message);
        ok = 0;
        goto cleanup;
    }
    ...
    if (!strstr(actual_text, "function pick params=0 locals=0 spills=0") ||
        !strstr(actual_text, "function get params=0 locals=0 spills=0") ||
        !strstr(actual_text, "reg.1 = call pick()") ||
        !strstr(actual_text, "reg.0 = load_global global.1") ||
        !strstr(actual_text, "call __builtin_fadd32(reg.1, reg.0)") ||
        !strstr(actual_text, "ret reg.0")) {
        fprintf(stderr,
            "[machine-select] FAIL: MACHINE-SELECT-FLOAT-HELPER-TERNARY-CALL-ARITH-ACCEPT dump mismatch\nactual:\n%s\n",
            actual_text ? actual_text : "<null>");
        ok = 0;
    }
...
static int test_machine_select_accepts_unary_call_helper_wrapped_ternary_call_arithmetic_under_extension(void) {
    static const char *source =
        "float id(float x){ return x; }\n"
    ...
    if (!build_machine_ir_report_from_default_extension_source_text(source, &machine_report, &machine_error) ||
        ...
        !machine_select_dump_lower_report_artifact(&select_report, &actual_text, &select_error)) {
        fprintf(stderr,
            "[machine-select] FAIL: MACHINE-SELECT-FLOAT-UNARY-HELPER-TERNARY-CALL-ARITH-ACCEPT setup failed: %s\n",
            select_error.message[0] ? select_error.message : machine_error.message);
        ok = 0;
        goto cleanup;
    }
    ...
    if (!strstr(actual_text, "function pick params=1 locals=1 spills=0") ||
        ...
        !strstr(actual_text, "spill.0 = load_local local.0") ||
        !strstr(actual_text, "reg.0 = call pick(spill.0)") ||
        !strstr(actual_text, "call __builtin_fadd32(reg.0, spill.0)") ||
        !strstr(actual_text, "ret reg.0")) {
        fprintf(stderr,
            "[machine-select] FAIL: MACHINE-SELECT-FLOAT-UNARY-HELPER-TERNARY-CALL-ARITH-ACCEPT dump mismatch\nactual:\n%s\n",
            actual_text ? actual_text : "<null>");
        ok = 0;
    }
...
static int test_machine_select_accepts_float_helper_wrapped_ternary_call_compare_under_extension(void) {
    static const char *source =
        "float g = 1.25;\n"
        "float h = 2.5;\n"
        "float pick(){ return g ? h : h; }\n"
    ...
    if (!build_machine_ir_report_from_default_extension_source_text(source, &machine_report, &machine_error) ||
        ...
        !machine_select_dump_lower_report_artifact(&select_report, &actual_text, &select_error)) {
        fprintf(stderr,
            "[machine-select] FAIL: MACHINE-SELECT-FLOAT-HELPER-TERNARY-CALL-COMPARE-ACCEPT setup failed: %s\n",
            select_error.message[0] ? select_error.message : machine_error.message);
        ok = 0;
        goto cleanup;
    }
    ...
    if (!strstr(actual_text, "function pick params=0 locals=0 spills=0") ||
        ...
        !strstr(actual_text, "reg.1 = call pick()") ||
        !strstr(actual_text, "reg.0 = cmp.10 reg.2, reg.0") ||
        !strstr(actual_text, "ret reg.0")) {
        fprintf(stderr,
            "[machine-select] FAIL: MACHINE-SELECT-FLOAT-HELPER-TERNARY-CALL-COMPARE-ACCEPT dump mismatch\nactual:\n%s\n",
            actual_text ? actual_text : "<null>");
        ok = 0;
    }
...
static int test_machine_select_accepts_unary_call_helper_wrapped_ternary_call_compare_under_extension(void) {
    static const char *source =
        "float id(float x){ return x; }\n"
        "float pick(float x){ return -id(x) ? x : x; }\n"
    ...
    if (!build_machine_ir_report_from_default_extension_source_text(source, &machine_report, &machine_error) ||
        ...
        !machine_select_dump_lower_report_artifact(&select_report, &actual_text, &select_error)) {
        fprintf(stderr,
            "[machine-select] FAIL: MACHINE-SELECT-FLOAT-UNARY-HELPER-TERNARY-CALL-COMPARE-ACCEPT setup failed: %s\n",
            select_error.message[0] ? select_error.message : machine_error.message);
        ok = 0;
        goto cleanup;
    }
    ...
    if (!strstr(actual_text, "function pick params=1 locals=1 spills=0") ||
        ...
        !strstr(actual_text, "spill.0 = load_local local.0") ||
        !strstr(actual_text, "reg.1 = call pick(spill.0)") ||
        !strstr(actual_text, "reg.1 = alu.2 reg.1, reg.0") ||
        !strstr(actual_text, "reg.0 = alu.2 spill.0, reg.0") ||
        !strstr(actual_text, "reg.0 = cmp.10 reg.1, reg.0") ||
        !strstr(actual_text, "ret reg.0")) {
        fprintf(stderr,
            "[machine-select] FAIL: MACHINE-SELECT-FLOAT-UNARY-HELPER-TERNARY-CALL-COMPARE-ACCEPT dump mismatch\nactual:\n%s\n",
            actual_text ? actual_text : "<null>");
        ok = 0;
    }
...
static int test_machine_select_accepts_chained_float_addition_assignment_to_float_under_extension(void) {
    static const char *source =
    ...
    if (!build_machine_ir_report_from_default_extension_source_text(source, &machine_report, &machine_error) ||
        ...
        !machine_select_dump_lower_report_artifact(&select_report, &actual_text, &select_error)) {
        fprintf(stderr,
            "[machine-select] FAIL: MACHINE-SELECT-FLOAT-CHAIN-ADD-ASSIGN-FLOAT-ACCEPT setup failed: %s\n",
            select_error.message[0] ? select_error.message : machine_error.message);
        ok = 0;
        goto cleanup;
    }
    ...
    if (!strstr(actual_text, "function f params=3") ||
        ...
        !strstr(actual_text, "ret reg.")) {
        fprintf(stderr,
            "[machine-select] FAIL: MACHINE-SELECT-FLOAT-CHAIN-ADD-ASSIGN-FLOAT-ACCEPT dump mismatch\nactual:\n%s\n",
            actual_text ? actual_text : "<null>");
        ok = 0;
    }
...
static int test_machine_select_accepts_nested_float_mul_div_assignment_to_float_under_extension(void) {
    static const char *source =
    ...
    if (!build_machine_ir_report_from_default_extension_source_text(source, &machine_report, &machine_error) ||
        ...
        !machine_select_dump_lower_report_artifact(&select_report, &actual_text, &select_error)) {
        fprintf(stderr,
            "[machine-select] FAIL: MACHINE-SELECT-FLOAT-NESTED-MUL-DIV-ASSIGN-FLOAT-ACCEPT setup failed: %s\n",
            select_error.message[0] ? select_error.message : machine_error.message);
        ok = 0;
        goto cleanup;
    }
    ...
    if (!strstr(actual_text, "function f params=3") ||
        ...
        !strstr(actual_text, "ret reg.")) {
        fprintf(stderr,
            "[machine-select] FAIL: MACHINE-SELECT-FLOAT-NESTED-MUL-DIV-ASSIGN-FLOAT-ACCEPT dump mismatch\nactual:\n%s\n",
            actual_text ? actual_text : "<null>");
        ok = 0;
    }
...
static int test_machine_select_accepts_chained_float_addition_initializer_to_float_under_extension(void) {
    static const char *source =
    ...
    if (!build_machine_ir_report_from_default_extension_source_text(source, &machine_report, &machine_error) ||
        ...
        !machine_select_dump_lower_report_artifact(&select_report, &actual_text, &select_error)) {
        fprintf(stderr,
            "[machine-select] FAIL: MACHINE-SELECT-FLOAT-CHAIN-ADD-INIT-FLOAT-ACCEPT setup failed: %s\n",
            select_error.message[0] ? select_error.message : machine_error.message);
        ok = 0;
        goto cleanup;
    }
    ...
    if (!strstr(actual_text, "function f params=3") ||
        ...
        !strstr(actual_text, "ret reg.")) {
        fprintf(stderr,
            "[machine-select] FAIL: MACHINE-SELECT-FLOAT-CHAIN-ADD-INIT-FLOAT-ACCEPT dump mismatch\nactual:\n%s\n",
            actual_text ? actual_text : "<null>");
        ok = 0;
    }
...
static int test_machine_select_accepts_nested_float_mul_div_initializer_to_float_under_extension(void) {
    static const char *source =
    ...
    if (!build_machine_ir_report_from_default_extension_source_text(source, &machine_report, &machine_error) ||
        ...
        !machine_select_dump_lower_report_artifact(&select_report, &actual_text, &select_error)) {
        fprintf(stderr,
            "[machine-select] FAIL: MACHINE-SELECT-FLOAT-NESTED-MUL-DIV-INIT-FLOAT-ACCEPT setup failed: %s\n",
            select_error.message[0] ? select_error.message : machine_error.message);
        ok = 0;
        goto cleanup;
    }
    ...
    if (!strstr(actual_text, "function f params=3") ||
        ...
        !strstr(actual_text, "ret reg.")) {
        fprintf(stderr,
            "[machine-select] FAIL: MACHINE-SELECT-FLOAT-NESTED-MUL-DIV-INIT-FLOAT-ACCEPT dump mismatch\nactual:\n%s\n",
            actual_text ? actual_text : "<null>");
        ok = 0;
    }
...
int main(void) {
    ...
    if (filter && filter[0] != '\0') {
        ...
        if (strstr("MACHINE-SELECT-FLOAT-CHAIN-ADD-EQ-COMPARE-ACCEPT", filter) != NULL) {
            return test_machine_select_accepts_chained_float_equality_compare_under_extension() ? 0 : 1;
        }
        if (strstr("MACHINE-SELECT-FLOAT-CHAIN-ADD-LT-COMPARE-ACCEPT", filter) != NULL) {
            return test_machine_select_accepts_chained_float_relational_compare_under_extension() ? 0 : 1;
        }
        if (strstr("MACHINE-SELECT-FLOAT-CHAIN-ADD-NE-COMPARE-ACCEPT", filter) != NULL) {
            return test_machine_select_accepts_chained_float_inequality_compare_under_extension() ? 0 : 1;
        }
        if (strstr("MACHINE-SELECT-FLOAT-CHAIN-ADD-LE-COMPARE-ACCEPT", filter) != NULL) {
            return test_machine_select_accepts_chained_float_le_compare_under_extension() ? 0 : 1;
        }
        if (strstr("MACHINE-SELECT-FLOAT-NESTED-MUL-DIV-EQ-COMPARE-ACCEPT", filter) != NULL) {
            return test_machine_select_accepts_nested_muldiv_float_equality_compare_under_extension() ? 0 : 1;
        }
        if (strstr("MACHINE-SELECT-FLOAT-NESTED-MUL-DIV-LT-COMPARE-ACCEPT", filter) != NULL) {
            return test_machine_select_accepts_nested_muldiv_float_relational_compare_under_extension() ? 0 : 1;
        }
        if (strstr("MACHINE-SELECT-FLOAT-NESTED-MUL-DIV-NE-COMPARE-ACCEPT", filter) != NULL) {
            return test_machine_select_accepts_nested_muldiv_float_inequality_compare_under_extension() ? 0 : 1;
        }
        if (strstr("MACHINE-SELECT-FLOAT-NESTED-MUL-DIV-GE-COMPARE-ACCEPT", filter) != NULL) {
            return test_machine_select_accepts_nested_muldiv_float_ge_compare_under_extension() ? 0 : 1;
        }
        ...
        if (strstr("MACHINE-SELECT-FLOAT-HELPER-TERNARY-CALL-ARITH-ACCEPT", filter) != NULL) {
            return test_machine_select_accepts_float_helper_wrapped_ternary_call_arithmetic_under_extension() ? 0 : 1;
        }
        if (strstr("MACHINE-SELECT-FLOAT-UNARY-HELPER-TERNARY-CALL-ARITH-ACCEPT", filter) != NULL) {
            return test_machine_select_accepts_unary_call_helper_wrapped_ternary_call_arithmetic_under_extension() ? 0 : 1;
        }
        if (strstr("MACHINE-SELECT-FLOAT-HELPER-TERNARY-CALL-COMPARE-ACCEPT", filter) != NULL) {
            return test_machine_select_accepts_float_helper_wrapped_ternary_call_compare_under_extension() ? 0 : 1;
        }
        if (strstr("MACHINE-SELECT-FLOAT-UNARY-HELPER-TERNARY-CALL-COMPARE-ACCEPT", filter) != NULL) {
            return test_machine_select_accepts_unary_call_helper_wrapped_ternary_call_compare_under_extension() ? 0 : 1;
        }
        ...
        if (strstr("MACHINE-SELECT-FLOAT-CHAIN-ADD-ASSIGN-FLOAT-ACCEPT", filter) != NULL) {
            return test_machine_select_accepts_chained_float_addition_assignment_to_float_under_extension() ? 0 : 1;
        }
        if (strstr("MACHINE-SELECT-FLOAT-NESTED-MUL-DIV-ASSIGN-FLOAT-ACCEPT", filter) != NULL) {
            return test_machine_select_accepts_nested_float_mul_div_assignment_to_float_under_extension() ? 0 : 1;
        }
        if (strstr("MACHINE-SELECT-FLOAT-CHAIN-ADD-INIT-FLOAT-ACCEPT", filter) != NULL) {
            return test_machine_select_accepts_chained_float_addition_initializer_to_float_under_extension() ? 0 : 1;
        }
        if (strstr("MACHINE-SELECT-FLOAT-NESTED-MUL-DIV-INIT-FLOAT-ACCEPT", filter) != NULL) {
            return test_machine_select_accepts_nested_float_mul_div_initializer_to_float_under_extension() ? 0 : 1;
        }
    ...
    if (!test_machine_select_accepts_chained_float_equality_compare_under_extension()) {
        return 1;
    }
    if (!test_machine_select_accepts_chained_float_relational_compare_under_extension()) {
        return 1;
    }
    if (!test_machine_select_accepts_chained_float_inequality_compare_under_extension()) {
        return 1;
    }
    if (!test_machine_select_accepts_chained_float_le_compare_under_extension()) {
        return 1;
    }
    if (!test_machine_select_accepts_nested_muldiv_float_equality_compare_under_extension()) {
        return 1;
    }
    if (!test_machine_select_accepts_nested_muldiv_float_relational_compare_under_extension()) {
        return 1;
    }
    if (!test_machine_select_accepts_nested_muldiv_float_inequality_compare_under_extension()) {
        return 1;
    }
    if (!test_machine_select_accepts_nested_muldiv_float_ge_compare_under_extension()) {
        return 1;
    }
    ...
    if (!test_machine_select_accepts_float_helper_wrapped_ternary_call_arithmetic_under_extension()) {
        return 1;
    }
    if (!test_machine_select_accepts_unary_call_helper_wrapped_ternary_call_arithmetic_under_extension()) {
        return 1;
    }
    if (!test_machine_select_accepts_float_helper_wrapped_ternary_call_compare_under_extension()) {
        return 1;
    }
    if (!test_machine_select_accepts_unary_call_helper_wrapped_ternary_call_compare_under_extension()) {
        return 1;
    }
