...
static int test_machine_journal_mainline(void) {
    ...
    ok &= verify_journal_file(
        ...
        "machine_journal profile=generic-elf32 log=preview-log timeline=preview-timeline origin-status=ready origin-pc=0x1000 origin-sp=0x4000 origin-segment=0 mapped_bytes=8192 records=1 record-index=0\n"
        "journal: resolution=preview-journal kind=value-journal log=value-log timeline=value-timeline history=value-history outcome=value-available event=register-result trace=preview-trace change-class=program-counter-and-fetch apply=pending-register-application commit=deferred-register-commit writeback=deferred-register-writeback mutation=deferred-register-result effect=value-result transition=next-fetch action=advance raw=0x1c value=0x0c known=yes name=load-local bytes=1 payload=[] imm=- exact=no single-record=yes records=1 record-index=0 origin-status=ready observed-status=ready status-changed=no pc-changed=yes stack-changed=no fetch-changed=yes targets=[] return-imm=-\n");
...
static int test_machine_journal_custom_step_cases(void) {
    ...
    ok &= verify_journal_file(
        ...
        "machine_journal profile=generic-elf32 log=exact-log timeline=exact-timeline origin-status=ready origin-pc=0x1000 origin-sp=0x4000 origin-segment=0 mapped_bytes=8192 records=1 record-index=0\n"
    ...
    ok &= verify_journal_file(
        ...
        "machine_journal profile=generic-elf32 log=blocked-on-control timeline=blocked-on-control origin-status=ready origin-pc=0x1000 origin-sp=0x4000 origin-segment=0 mapped_bytes=8192 records=1 record-index=0\n"
    ...
    ok &= verify_journal_file(
        ...
        "machine_journal profile=generic-elf32 log=blocked-unsupported timeline=blocked-unsupported origin-status=ready origin-pc=0x1000 origin-sp=0x4000 origin-segment=0 mapped_bytes=8192 records=1 record-index=0\n"
    ...
    ok &= verify_journal_file(
        ...
        "machine_journal profile=generic-elf32 log=preview-log timeline=preview-timeline origin-status=ready origin-pc=0x1000 origin-sp=0x4000 origin-segment=0 mapped_bytes=8192 records=1 record-index=0\n"
        "journal: resolution=preview-journal kind=local-update-journal log=local-update-log timeline=local-update-timeline history=local-update-history outcome=local-updated event=local-store trace=preview-trace change-class=program-counter-and-fetch apply=pending-local-application commit=deferred-local-commit writeback=deferred-local-writeback mutation=deferred-local-slot effect=local-slot transition=next-fetch action=advance raw=0x1e value=0x0e known=yes name=store-local-imm bytes=2 payload=[0x07] imm=7 exact=no single-record=yes records=1 record-index=0 origin-status=ready observed-status=ready status-changed=no pc-changed=yes stack-changed=no fetch-changed=yes targets=[] return-imm=-\n");
    ...
    ok &= verify_journal_file(
        ...
        "machine_journal profile=generic-elf32 log=preview-log timeline=preview-timeline origin-status=ready origin-pc=0x1000 origin-sp=0x4000 origin-segment=0 mapped_bytes=8192 records=1 record-index=0\n"
        "journal: resolution=preview-journal kind=global-update-journal log=global-update-log timeline=global-update-timeline history=global-update-history outcome=global-updated event=global-store trace=preview-trace change-class=program-counter-and-fetch apply=pending-global-application commit=deferred-global-commit writeback=deferred-global-writeback mutation=deferred-global-slot effect=global-slot transition=next-fetch action=advance raw=0x21 value=0x11 known=yes name=store-global-imm bytes=2 payload=[0x05] imm=5 exact=no single-record=yes records=1 record-index=0 origin-status=ready observed-status=ready status-changed=no pc-changed=yes stack-changed=no fetch-changed=yes targets=[] return-imm=-\n");
...
static int test_machine_journal_i386_bridge(void) {
    ...
    ok &= expect_text("journal i386 dump wrapper", dump_text,
        "machine_journal profile=i386-preview log=preview-log timeline=preview-timeline origin-status=ready origin-pc=0x8048000 origin-sp=0x804b000 origin-segment=0 mapped_bytes=8192 records=1 record-index=0\n"
        "journal: resolution=preview-journal kind=value-journal log=value-log timeline=value-timeline history=value-history outcome=value-available event=register-result trace=preview-trace change-class=program-counter-and-fetch apply=pending-register-application commit=deferred-register-commit writeback=deferred-register-writeback mutation=deferred-register-result effect=value-result transition=next-fetch action=advance raw=0x1c value=0x0c known=yes name=load-local bytes=1 payload=[] imm=- exact=no single-record=yes records=1 record-index=0 origin-status=ready observed-status=ready status-changed=no pc-changed=yes stack-changed=no fetch-changed=yes targets=[] return-imm=-\n");
