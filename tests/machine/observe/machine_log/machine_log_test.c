...
static int test_machine_log_mainline(void) {
    ...
    ok &= verify_log_file(
        ...
        "machine_log profile=generic-elf32 timeline=preview-timeline origin-status=ready origin-pc=0x1000 origin-sp=0x4000 origin-segment=0 mapped_bytes=8192 lines=1 line-index=0\n"
...
static int test_machine_log_custom_step_cases(void) {
    ...
    ok &= verify_log_file(
        ...
        "machine_log profile=generic-elf32 timeline=exact-timeline origin-status=ready origin-pc=0x1000 origin-sp=0x4000 origin-segment=0 mapped_bytes=8192 lines=1 line-index=0\n"
    ...
    ok &= verify_log_file(
        ...
        "machine_log profile=generic-elf32 timeline=blocked-on-control origin-status=ready origin-pc=0x1000 origin-sp=0x4000 origin-segment=0 mapped_bytes=8192 lines=1 line-index=0\n"
    ...
    ok &= verify_log_file(
        ...
        "machine_log profile=generic-elf32 timeline=blocked-unsupported origin-status=ready origin-pc=0x1000 origin-sp=0x4000 origin-segment=0 mapped_bytes=8192 lines=1 line-index=0\n"
...
static int test_machine_log_i386_bridge(void) {
    ...
    ok &= expect_text("log i386 dump wrapper", dump_text,
        "machine_log profile=i386-preview timeline=preview-timeline origin-status=ready origin-pc=0x8048000 origin-sp=0x804b000 origin-segment=0 mapped_bytes=8192 lines=1 line-index=0\n"
        "log: resolution=preview-log kind=value-log timeline=value-timeline history=value-history outcome=value-available event=register-result trace=preview-trace change-class=program-counter-and-fetch apply=pending-register-application commit=deferred-register-commit writeback=deferred-register-writeback mutation=deferred-register-result effect=value-result transition=next-fetch action=advance raw=0x1c value=0x0c known=yes name=load-local bytes=1 payload=[] imm=- exact=no single-line=yes lines=1 line-index=0 origin-status=ready observed-status=ready status-changed=no pc-changed=yes stack-changed=no fetch-changed=yes targets=[] return-imm=-\n");
