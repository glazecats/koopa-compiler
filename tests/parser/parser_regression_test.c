...
int main(void) {
    ...
    ok &= test_ast_records_local_function_declaration_metadata();
    ok &= test_ast_records_local_void_function_declaration_metadata();
    ok &= test_ast_rejects_non_function_local_void_declaration();
    ok &= test_ast_records_closure_literal_metadata();
